...
load(file = "bauges_results/bauges_2_params_poiss.Rda")
load(file =  "bauges_results/bauges_2_params_negbin.Rda")
load(file =  "bauges_results/bauges_2_params_ibp.Rda" )
load(file =  "bauges_results/bauges_2_params_sp.Rda" )

###### 2) Read results: samples from limiting distributions (Poiss/NB) ##############
load(file = "bauges_results/bauges_2_ntilde_poiss.Rda")
load(file = "bauges_results/bauges_2_ntilde_negbin.Rda")

###### 3) Read results: CI for extrapolation (Poiss/NB/Gamma) ################
list_kmn_pred_test_poiss <- readRDS(file = "bauges_results/bauges_2_ci_poiss.rds")
list_kmn_pred_test_negbin <- readRDS(file = "bauges_results/bauges_2_ci_negbin.rds")
list_kmn_pred_test_ibp <- readRDS(file = "bauges_results/bauges_2_ci_ibp.rds")
list_kmn_pred_test_sp <- readRDS(file = "bauges_results/bauges_2_ci_sp.rds")

###### 3.b) Read results: CI for insample (Poiss/NB/Gamma) ################
list_kn_rarefaction_poiss <- readRDS(file = "bauges_results/bauges_2_ci_insample_poiss.rds")
list_kn_rarefaction_negbin <- readRDS(file = "bauges_results/bauges_2_ci_insample_negbin.rds")
list_kn_rarefaction_ibp <- readRDS(file = "bauges_results/bauges_2_ci_insample_ibp.rds")
list_kn_rarefaction_sp <- readRDS(file = "bauges_results/bauges_2_ci_insample_sp.rds")


###### 4) Read the data ###############################
data_mat <- readRDS(file = "bauges_results/bauges_data_mat.rds")
...
# Print plots
fig_bauges_2_rare_ <- wrap_plots(gg_kn_rarefaction_all, nrow = 1, ncol = 3) +   plot_layout(guides = "collect") & theme(legend.position = 'right') & xlab(NULL) & theme(plot.margin = margin(5.5, 5.5, 0, 5.5))

fig_bauges_2_rare <- wrap_elements(panel = fig_bauges_2_rare_) +
  labs(tag = "# observations") +
  theme(
    plot.tag = element_text(size = rel(1)),
    plot.tag.position = "bottom") 

ggsave(filename = "Plots_paper/plot_bauges_2_rare.png", width = 10, height = 4, dpi = 300, units = "in", device='png')
...
# Print plots
fig_bauges_2_pred_ <- wrap_plots(gg_kmn_pred_test_all, nrow = 1, ncol = 3) +   plot_layout(guides = "collect") & theme(legend.position = 'right') & xlab(NULL) & theme(plot.margin = margin(5.5, 5.5, 0, 5.5))

fig_bauges_2_pred <- wrap_elements(panel = fig_bauges_2_pred_) +
  labs(tag = "# observations") +
  theme(
    plot.tag = element_text(size = rel(1)),
    plot.tag.position = "bottom") 

ggsave(filename = "Plots_paper/plot_bauges_2_pred.png", width = 10, height = 4, dpi = 300, units = "in", device='png')
...
ggsave(filename = "Plots_paper/plot_bauges_2_richness.png", width = 10, height = 4, dpi = 300, units = "in", device='png')



##########################################################
#### (B) Only prediction - NOT INTERESTING (haven't run) ###
##########################################################
rm(list=ls())
###### 1) Read results:  MCMC convergence ####################
load(file = "bauges_results/bauges_2_op_params_poiss.Rda")
load(file =  "bauges_results/bauges_2_op_params_negbin.Rda")
load(file =  "bauges_results/bauges_2_op_params_ibp.Rda" )
load(file =  "bauges_results/bauges_2_op_params_sp.Rda" )
...
###### 2) Read results: samples from limiting distributions (Poiss/NB) ##############
load(file = "bauges_results/bauges_2_op_ntilde_poiss.Rda")
load(file = "bauges_results/bauges_2_op_ntilde_negbin.Rda")

###### 3.b) Read results: CI for insample (Poiss/NB/Gamma) ################
kn_rarefaction_poiss <- readRDS(file = "bauges_results/bauges_2_op_ci_insample_poiss.rds")
kn_rarefaction_negbin <- readRDS(file = "bauges_results/bauges_2_op_ci_insample_negbin.rds")
kn_rarefaction_ibp <- readRDS(file = "bauges_results/bauges_2_op_ci_insample_ibp.rds")
kn_rarefaction_sp <- readRDS(file = "bauges_results/bauges_2_op_ci_insample_sp.rds")

###### 4) Read the data ###############################
data_mat <- readRDS(file = "bauges_results/bauges_2_data_mat.rds")
data_list <- create_features_list(data_mat)
L <- nrow(data_mat)
...
ggsave(filename = "Plots_paper/plot_bauges_2_op_rare.png", width = 10, height = 4, dpi = 300, units = "in", device='png')
...
# # # Poisson
# saveRDS(list_kmn_pred_poiss, "bauges_results/bauges_2_op_1000_ci_poiss.rds")
# # # Negative Binomial
# saveRDS(list_kmn_pred_negbin, "bauges_results/bauges_2_op_1000_ci_negbin.rds")
# # # Gamma IBP
# saveRDS(list_kmn_pred_ibp, "bauges_results/bauges_2_op_1000_ci_ibp.rds")
# # # SB-SP
# saveRDS(list_kmn_pred_sp, "bauges_results/bauges_2_op_1000_ci_sp.rds")


###### 7.b) Prediction on different horizons (results) - 1000 new subjects ########
list_kmn_pred_poiss <- readRDS(file = "bauges_results/bauges_2_op_1000_ci_poiss.rds")
list_kmn_pred_negbin <- readRDS(file = "bauges_results/bauges_2_op_1000_ci_negbin.rds")
list_kmn_pred_ibp <- readRDS(file = "bauges_results/bauges_2_op_1000_ci_ibp.rds")
list_kmn_pred_sp <- readRDS(file = "bauges_results/bauges_2_op_1000_ci_sp.rds")
...
ggsave(filename = "Plots_paper/plot_bauges_2_op_1000_pred.png", width = 8, height = 6, dpi = 300, units = "in", device='png')
...
# ######### Save results: CI for extrapolation (Poiss/NB/Gamma/SP)
# # Poisson
# saveRDS(list_kmn_pred_poiss, "bauges_results/bauges_2_op_small_ci_poiss.rds")
# # Negative Binomial
# saveRDS(list_kmn_pred_negbin, "bauges_results/bauges_2_op_small_ci_negbin.rds")
# # Gamma IBP
# saveRDS(list_kmn_pred_ibp, "bauges_results/bauges_2_op_small_ci_ibp.rds")
# # SB-SP
# saveRDS(list_kmn_pred_sp, "bauges_results/bauges_2_op_small_ci_sp.rds")


###### 7.d) Prediction on different horizons (results) - small-set new subjects ########
list_kmn_pred_poiss <- readRDS(file = "bauges_results/bauges_2_op_small_ci_poiss.rds")
list_kmn_pred_negbin <- readRDS(file = "bauges_results/bauges_2_op_small_ci_negbin.rds")
list_kmn_pred_ibp <- readRDS(file = "bauges_results/bauges_2_op_small_ci_ibp.rds")
list_kmn_pred_sp <- readRDS(file = "bauges_results/bauges_2_op_small_ci_sp.rds")
...
# Print plots
fig_bauges_2_pred_ <- wrap_plots(gg_kmn_pred_all, nrow = 1, ncol = length(Ts)) +   plot_layout(guides = "collect") & theme(legend.position = 'right') & xlab(NULL) & theme(plot.margin = margin(5.5, 5.5, 0, 5.5))
...
ggsave(filename = "Plots_paper/plot_bauges_2_op_small_pred.png", width = 8, height = 5, dpi = 300, units = "in", device='png')
