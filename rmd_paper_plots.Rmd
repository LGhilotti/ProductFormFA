...
load(file =  "chao_model_simulation/m1/m1_params_negbin_prior.Rda")
...
load(file = "chao_model_simulation/m1/m1_ntilde_negbin_prior.Rda")
...
list_kmn_pred_test_negbin_prior <- readRDS(file = "chao_model_simulation/m1/m1_ci_negbin_prior.rds")
...
list_kn_rarefaction_negbin_prior <- readRDS(file = "chao_model_simulation/m1/m1_ci_insample_negbin_prior.rds")
...
load(file = "chao_model_simulation/m1/m1_avg_ntilde_negbin_prior.Rda")
...
load(file = "chao_model_simulation/m1/m1_est_new_negbin_prior.Rda")
...
for (j in 1:length(Ns)){
  ...
  gg_kn_rarefaction_all[[j]] <- plot_Kn_median_and_rarefaction_all(
    ...
    ci_negbin_prior = list_kn_rarefaction_negbin_prior[[paste0("N.",N)]],
...
for (j in 1:length(Ns)){
  ...
  gg_kmn_pred_test_all[[j]] <- plot_Kmn_median_pred_and_test_all(
    ...
    ci_negbin_prior = list_kmn_pred_test_negbin_prior[[paste0("N.",N)]],
...
```{r, echo=FALSE, fig.align = "center"}
# Print plots
fig_m1_pred_ <- wrap_plots(gg_kmn_pred_test_all, nrow = 1, ncol = 3) +   plot_layout(guides = "collect") & theme(legend.position = 'right') & xlab(NULL) & theme(plot.margin = margin(5.5, 5.5, 0, 5.5))
