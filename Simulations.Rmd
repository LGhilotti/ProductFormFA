...
ggplot(joint_alt_long, aes( y=accuracy, fill=model)) + 
  ...
  ggtitle(paste0("Scenario 1: accuracy on D = ", D)) +
...
ggplot(gg_ntilde_poiss_long, aes(x = estimate, fill = training)) + 
  ...
  theme_bw() + 
  theme(plot.title = element_text(hjust = 0.5)) +
  ggtitle("Scenario 1, Poisson: limiting distributions") +
  scale_y_continuous(breaks = pretty_breaks()) 
...
ggplot(gg_ntilde_negbin_long, aes(x = estimate, fill = training)) + 
  ...
  theme_bw() + 
  theme(plot.title = element_text(hjust = 0.5)) +
  ggtitle("Scenario 1, Neg-Bin: limiting distributions") +
  scale_y_continuous(breaks = pretty_breaks()) +
  xlim(400,1200)
```
...
ggplot(joint_ntilde_long, aes( y=estimate, fill=model)) + 
  ...
  theme_bw() + 
  theme(plot.title = element_text(hjust = 0.5)) +
  ggtitle(paste0("Scenario 1: average on D = ", D)) +
  scale_y_continuous(breaks = pretty_breaks()) 
...
ggplot(joint_alt_long, aes( y=accuracy, fill=model)) + 
  ...
  theme_bw() + 
  theme(plot.title = element_text(hjust = 0.5)) +
  ggtitle(paste0("Scenario 2: accuracy on D = ", D)) +
  scale_y_continuous(breaks = pretty_breaks()) 
...
ggplot(gg_ntilde_poiss_long, aes(x = estimate, fill = training)) + 
  ...
  theme_bw() + 
  theme(plot.title = element_text(hjust = 0.5)) +
  ggtitle("Scenario 2, Poisson: limiting distributions") +
  scale_y_continuous(breaks = pretty_breaks()) 
...
ggplot(gg_ntilde_negbin_long, aes(x = estimate, fill = training)) + 
  ...
  theme_bw() + 
  theme(plot.title = element_text(hjust = 0.5)) +
  ggtitle("Scenario 2, Neg-Bin: limiting distributions") +
  scale_y_continuous(breaks = pretty_breaks()) 
...
ggplot(joint_ntilde_long, aes( y=estimate, fill=model)) + 
  ...
  theme_bw() + 
  theme(plot.title = element_text(hjust = 0.5)) +
  ggtitle(paste0("Scenario 2: average on D = ", D)) +
  scale_y_continuous(breaks = pretty_breaks()) 
...
ggplot(joint_alt_long, aes( y=accuracy, fill=model)) + 
  ...
  theme_bw() + 
  theme(plot.title = element_text(hjust = 0.5)) +
  ggtitle(paste0("Scenario 3: accuracy on D = ", D)) +
  scale_y_continuous(breaks = pretty_breaks()) 
...
ggplot(gg_ntilde_poiss_long, aes(x = estimate, fill = training)) + 
  ...
  theme_bw() + 
  theme(plot.title = element_text(hjust = 0.5)) +
  ggtitle("Scenario 3, Poisson: limiting distributions") +
  scale_y_continuous(breaks = pretty_breaks()) 
...
ggplot(gg_ntilde_negbin_long, aes(x = estimate, fill = training)) + 
  ...
  theme_bw() + 
  theme(plot.title = element_text(hjust = 0.5)) +
  ggtitle("Scenario 3, Neg-Bin: limiting distributions") +
  scale_y_continuous(breaks = pretty_breaks()) + 
  xlim(200,1200)
...
ggplot(joint_ntilde_long, aes( y=estimate, fill=model)) + 
  ...
  theme_bw() + 
  theme(plot.title = element_text(hjust = 0.5)) +
  ggtitle(paste0("Scenario 3: average on D = ", D)) +
  scale_y_continuous(breaks = pretty_breaks()) 
...
ggplot(joint_alt_long, aes( y=accuracy, fill=model)) + 
  ...
  theme_bw() + 
  theme(plot.title = element_text(hjust = 0.5)) +
  ggtitle(paste0("Scenario 4: accuracy on D = ", D)) +
  scale_y_continuous(breaks = pretty_breaks()) 
...
ggplot(gg_ntilde_poiss_long, aes(x = estimate, fill = training)) + 
  ...
  theme_bw() + 
  theme(plot.title = element_text(hjust = 0.5)) +
  ggtitle("Scenario 4, Poisson: limiting distributions") +
  scale_y_continuous(breaks = pretty_breaks()) 
...
ggplot(gg_ntilde_negbin_long, aes(x = estimate, fill = training)) + 
  ...
  theme_bw() + 
  theme(plot.title = element_text(hjust = 0.5)) +
  ggtitle("Scenario 4, Neg-Bin: limiting distributions") +
  scale_y_continuous(breaks = pretty_breaks()) + 
  xlim(200,1500)
...
ggplot(joint_ntilde_long, aes( y=estimate, fill=model)) + 
  ...
  theme_bw() + 
  theme(plot.title = element_text(hjust = 0.5)) +
  ggtitle(paste0("Scenario 4: average on D = ", D)) +
  scale_y_continuous(breaks = pretty_breaks()) 
...
ggplot(joint_alt_long, aes( y=accuracy, fill=model)) + 
  ...
  theme_bw() + 
  theme(plot.title = element_text(hjust = 0.5)) +
  ggtitle(paste0("Scenario 5: accuracy on D = ", D)) +
  scale_y_continuous(breaks = pretty_breaks()) 
...
ggplot(gg_ntilde_poiss_long, aes(x = estimate, fill = training)) + 
  ...
  theme_bw() + 
  theme(plot.title = element_text(hjust = 0.5)) +
  ggtitle("Scenario 5, Poisson: limiting distributions") +
  scale_y_continuous(breaks = pretty_breaks()) 
...
ggplot(gg_ntilde_negbin_long, aes(x = estimate, fill = training)) + 
  ...
  theme_bw() + 
  theme(plot.title = element_text(hjust = 0.5)) +
  ggtitle("Scenario 5, Neg-Bin: limiting distributions") +
  scale_y_continuous(breaks = pretty_breaks())  +
  xlim(0,3000)
...
ggplot(joint_ntilde_long, aes( y=estimate, fill=model)) + 
  ...
  theme_bw() + 
  theme(plot.title = element_text(hjust = 0.5)) +
  ggtitle(paste0("Scenario 5: average on D = ", D)) +
  scale_y_continuous(breaks = pretty_breaks()) 
...
###### 3.b) Read results: CI for insample (Poiss/NB/Gamma) ################
list_kn_rarefaction_poiss <- readRDS(file = "unbounded_features_scenario/unb_poly_1_ci_insample_poiss.rds")
list_kn_rarefaction_negbin <- readRDS(file = "unbounded_features_scenario/unb_poly_1_ci_insample_negbin.rds")
list_kn_rarefaction_ibp <- readRDS(file = "unbounded_features_scenario/unb_poly_1_ci_insample_ibp.rds")
...
ggplot(joint_alt_long, aes( y=accuracy, fill=model)) + 
  ...
  theme_bw() + 
  theme(plot.title = element_text(hjust = 0.5)) +
  ggtitle(paste0("Unbounded-feature (exp 1): accuracy on D = ", D)) +
  scale_y_continuous(breaks = pretty_breaks()) 
...
###### 3.b) Read results: CI for insample (Poiss/NB/Gamma) ################
list_kn_rarefaction_poiss <- readRDS(file = "unbounded_features_scenario/unb_poly_0_8_ci_insample_poiss.rds")
list_kn_rarefaction_negbin <- readRDS(file = "unbounded_features_scenario/unb_poly_0_8_ci_insample_negbin.rds")
list_kn_rarefaction_ibp <- readRDS(file = "unbounded_features_scenario/unb_poly_0_8_ci_insample_ibp.rds")
...
ggplot(joint_alt_long, aes( y=accuracy, fill=model)) + 
  ...
  theme_bw() + 
  theme(plot.title = element_text(hjust = 0.5)) +
  ggtitle(paste0("Unbounded-feature (exp 0.8): accuracy on D = ", D)) +
  scale_y_continuous(breaks = pretty_breaks()) 
...
###### 3.b) Read results: CI for insample (Poiss/NB/Gamma) ################
list_kn_rarefaction_poiss <- readRDS(file = "unbounded_features_scenario/unb_poly_1_2_ci_insample_poiss.rds")
list_kn_rarefaction_negbin <- readRDS(file = "unbounded_features_scenario/unb_poly_1_2_ci_insample_negbin.rds")
list_kn_rarefaction_ibp <- readRDS(file = "unbounded_features_scenario/unb_poly_1_2_ci_insample_ibp.rds")
...
ggplot(joint_alt_long, aes( y=accuracy, fill=model)) + 
  ...
  theme_bw() + 
  theme(plot.title = element_text(hjust = 0.5)) +
  ggtitle(paste0("Unbounded-feature (exp 1.2): accuracy on D = ", D)) +
  scale_y_continuous(breaks = pretty_breaks()) 
