...
# Print plots
grid.arrange(grobs = gg_kn_rarefaction_all, ncol= 1)
...
```{r, echo=FALSE, fig.height=15, fig.align = "center"}
# Print plots
grid.arrange(grobs = gg_kmn_pred_test_all, ncol= 1)
