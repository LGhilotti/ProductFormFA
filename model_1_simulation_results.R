...
ggsave("chao_model_simulation/m1/m1_poiss_extr.pdf", width = 16, height = 8, units = "in")

# Negative Binomial
ggarrange(plotlist = gg_kmn_pred_test_negbin)
ggsave("chao_model_simulation/m1/m1_negbin_extr.pdf", width = 16, height = 8, units = "in")

# Gamma IBP
ggarrange(plotlist = gg_kmn_pred_test_ibp)
ggsave("chao_model_simulation/m1/m1_ibp_extr.pdf", width = 16, height = 8, units = "in")

# SB-SP
ggarrange(plotlist = gg_kmn_pred_test_sp)
ggsave("chao_model_simulation/m1/m1_sp_extr.pdf", width = 16, height = 8, units = "in")
