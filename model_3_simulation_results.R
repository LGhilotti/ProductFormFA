...
ggsave("chao_model_simulation/m3/m3_poiss_extr.pdf", width = 16, height = 8, units = "in")

# Negative Binomial
ggarrange(plotlist = gg_kmn_pred_test_negbin)
ggsave("chao_model_simulation/m3/m3_negbin_extr.pdf", width = 16, height = 8, units = "in")

# Gamma IBP
ggarrange(plotlist = gg_kmn_pred_test_ibp)
ggsave("chao_model_simulation/m3/m3_ibp_extr.pdf", width = 16, height = 8, units = "in")
...
load(file = "chao_model_simulation/m3/m3_acc_poiss.Rda")
load(file = "chao_model_simulation/m3/m3_acc_negbin.Rda")
load(file = "chao_model_simulation/m3/m3_acc_ibp.Rda")
