...
load(file = "mazziotta2016_application/lichens/mazz_lichens_op_params_poiss.Rda")
load(file =  "mazziotta2016_application/lichens/mazz_lichens_op_params_negbin.Rda")
load(file =  "mazziotta2016_application/lichens/mazz_lichens_op_params_ibp.Rda" )

###### 2) Read results: samples from limiting distributions (Poiss/NB) ##############
load(file = "mazziotta2016_application/lichens/mazz_lichens_op_ntilde_poiss.Rda")
load(file = "mazziotta2016_application/lichens/mazz_lichens_op_ntilde_negbin.Rda")

list_kmn_pred_poiss <- readRDS(file = "mazziotta2016_application/lichens/mazz_lichens_op_ci_pred_poiss.rds")

###### 3) Read the data ###############################
data_mat <- readRDS(file = "mazziotta2016_application/lichens/mazz_lichens_data_mat.rds")
...
ggsave(filename = "Plots_paper/plot_lichens_op_richness_distribution.pdf", width = 3.5, height = 4, dpi = 300, units = "in", device='pdf')


######## 5) Extrapolation - Poisson, NegBin, Chao and GT ###############
list_kmn_pred_poiss <- readRDS(file = "mazziotta2016_application/lichens/mazz_lichens_op_ci_pred_poiss.rds")
list_kmn_pred_negbin <- readRDS(file = "mazziotta2016_application/lichens/mazz_lichens_op_ci_pred_negbin.rds")
list_kmn_pred_ibp <- readRDS(file = "mazziotta2016_application/lichens/mazz_lichens_op_ci_pred_ibp.rds")
...
# saveRDS(list_kmn_pred_gt, "mazziotta2016_application/lichens/mazz_lichens_op_gt_prediction.rds")

# read
list_kmn_pred_gt <- readRDS(file = "mazziotta2016_application/lichens/mazz_lichens_gt_prediction.rds")
...
# 
# # Chao rarefaction
# saveRDS(list_chao_rare, "mazziotta2016_application/lichens/mazz_lichens_chao_rare.rds")

list_chao_pred <- readRDS(file = "mazziotta2016_application/lichens/mazz_lichens_chao_rare.rds")
...
ggsave(filename = "Plots_paper/plot_lichens_op_prediction.pdf", width = 5, height = 4, dpi = 300, units = "in", device='pdf')
