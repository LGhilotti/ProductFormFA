...
fungi2016_mat <- read_excel('mazziotta2016_results/mazz2016_data.xls',
                             sheet = "Fungi") %>%
...
save(params_poiss, file = "mazziotta2016_results/mazz_fungi_params_poiss.Rda")
save(params_negbin, file = "mazziotta2016_results/mazz_fungi_params_negbin.Rda")
save(params_ibp, file = "mazziotta2016_results/mazz_fungi_params_ibp.Rda")
save(params_sp, file = "mazziotta2016_results/mazz_fungi_params_sp.Rda")

############ 9) Save results: samples from limiting distributions (Poiss/NB) ##############
# Poisson
save(gg_ntilde_poiss, file = "mazziotta2016_results/mazz_fungi_ntilde_poiss.Rda")
# Negative Binomial
save(gg_ntilde_negbin, file = "mazziotta2016_results/mazz_fungi_ntilde_negbin.Rda")

######### 10) Save results: CI for extrapolation (Poiss/NB/Gamma/SP) ################
# Poisson
saveRDS(list_kmn_pred_test_poiss, "mazziotta2016_results/mazz_fungi_ci_poiss.rds")
# Negative Binomial
saveRDS(list_kmn_pred_test_negbin, "mazziotta2016_results/mazz_fungi_ci_negbin.rds")
# Gamma IBP
saveRDS(list_kmn_pred_test_ibp, "mazziotta2016_results/mazz_fungi_ci_ibp.rds")
# SB-SP
saveRDS(list_kmn_pred_test_sp, "mazziotta2016_results/mazz_fungi_ci_sp.rds")

######### 10.b) Save results: CI for rarefaction (Poiss/NB/Gamma/SP) ################
# Poisson
saveRDS(list_kn_rarefaction_poiss, "mazziotta2016_results/mazz_fungi_ci_insample_poiss.rds")
# Negative Binomial
saveRDS(list_kn_rarefaction_negbin, "mazziotta2016_results/mazz_fungi_ci_insample_negbin.rds")
# Gamma IBP
saveRDS(list_kn_rarefaction_ibp, "mazziotta2016_results/mazz_fungi_ci_insample_ibp.rds")
# SB-SP
saveRDS(list_kn_rarefaction_sp, "mazziotta2016_results/mazz_fungi_ci_insample_sp.rds")

######## 11) Save the data ##############################
saveRDS(data_mat, "mazziotta2016_results/mazz_fungi_data_mat.rds")
...
save(params_poiss, file = "mazziotta2016_results/mazz_fungi_op_params_poiss.Rda")
save(params_negbin, file = "mazziotta2016_results/mazz_fungi_op_params_negbin.Rda")
save(params_ibp, file = "mazziotta2016_results/mazz_fungi_op_params_ibp.Rda")
save(params_sp, file = "mazziotta2016_results/mazz_fungi_op_params_sp.Rda")

############ 9) Save results: samples from limiting distributions (Poiss/NB) ##############
# Poisson
save(gg_ntilde_poiss, file = "mazziotta2016_results/mazz_fungi_op_ntilde_poiss.Rda")
# Negative Binomial
save(gg_ntilde_negbin, file = "mazziotta2016_results/mazz_fungi_op_ntilde_negbin.Rda")

######### 10.b) Save results: CI for rarefaction (Poiss/NB/Gamma/SP) ################
# Poisson
saveRDS(kn_rarefaction_poiss, "mazziotta2016_results/mazz_fungi_op_ci_insample_poiss.rds")
# Negative Binomial
saveRDS(kn_rarefaction_negbin, "mazziotta2016_results/mazz_fungi_op_ci_insample_negbin.rds")
# Gamma IBP
saveRDS(kn_rarefaction_ibp, "mazziotta2016_results/mazz_fungi_op_ci_insample_ibp.rds")
# SB-SP
saveRDS(kn_rarefaction_sp, "mazziotta2016_results/mazz_fungi_op_ci_insample_sp.rds")
