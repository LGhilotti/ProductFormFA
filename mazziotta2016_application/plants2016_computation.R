...
plants2016_mat <- read_excel('mazziotta2016_results/mazz2016_data.xls',
                            sheet = "Plants") %>%
  filter(is.na(Species) == F) %>%
  column_to_rownames(var = "Species")

plants2016_mat <- t(plants2016_mat)

freq <- colSums(plants2016_mat)
# to check that all species in the dataset are actually present 
sum(freq ==0) # must be =0

# number of sites
L = nrow(plants2016_mat)

set.seed(1234)
plants2016_mat <- plants2016_mat[sample.int(L, size = L, replace = F),]

plants2016_list <- create_features_list(plants2016_mat)
plot_trajectory(plants2016_list)

data_mat <- plants2016_mat
data_list <- plants2016_list
...
save(params_poiss, file = "mazziotta2016_results/mazz_plants_params_poiss.Rda")
save(params_negbin, file = "mazziotta2016_results/mazz_plants_params_negbin.Rda")
save(params_ibp, file = "mazziotta2016_results/mazz_plants_params_ibp.Rda")
save(params_sp, file = "mazziotta2016_results/mazz_plants_params_sp.Rda")

############ 9) Save results: samples from limiting distributions (Poiss/NB) ##############
# Poisson
save(gg_ntilde_poiss, file = "mazziotta2016_results/mazz_plants_ntilde_poiss.Rda")
# Negative Binomial
save(gg_ntilde_negbin, file = "mazziotta2016_results/mazz_plants_ntilde_negbin.Rda")

######### 10) Save results: CI for extrapolation (Poiss/NB/Gamma/SP) ################
# Poisson
saveRDS(list_kmn_pred_test_poiss, "mazziotta2016_results/mazz_plants_ci_poiss.rds")
# Negative Binomial
saveRDS(list_kmn_pred_test_negbin, "mazziotta2016_results/mazz_plants_ci_negbin.rds")
# Gamma IBP
saveRDS(list_kmn_pred_test_ibp, "mazziotta2016_results/mazz_plants_ci_ibp.rds")
# SB-SP
saveRDS(list_kmn_pred_test_sp, "mazziotta2016_results/mazz_plants_ci_sp.rds")

######### 10.b) Save results: CI for rarefaction (Poiss/NB/Gamma/SP) ################
# Poisson
saveRDS(list_kn_rarefaction_poiss, "mazziotta2016_results/mazz_plants_ci_insample_poiss.rds")
# Negative Binomial
saveRDS(list_kn_rarefaction_negbin, "mazziotta2016_results/mazz_plants_ci_insample_negbin.rds")
# Gamma IBP
saveRDS(list_kn_rarefaction_ibp, "mazziotta2016_results/mazz_plants_ci_insample_ibp.rds")
# SB-SP
saveRDS(list_kn_rarefaction_sp, "mazziotta2016_results/mazz_plants_ci_insample_sp.rds")

######## 11) Save the data ##############################
saveRDS(data_mat, "mazziotta2016_results/mazz_plants_data_mat.rds")
...
save(params_poiss, file = "mazziotta2016_results/mazz_plants_op_params_poiss.Rda")
save(params_negbin, file = "mazziotta2016_results/mazz_plants_op_params_negbin.Rda")
save(params_ibp, file = "mazziotta2016_results/mazz_plants_op_params_ibp.Rda")
save(params_sp, file = "mazziotta2016_results/mazz_plants_op_params_sp.Rda")

############ 9) Save results: samples from limiting distributions (Poiss/NB) ##############
# Poisson
save(gg_ntilde_poiss, file = "mazziotta2016_results/mazz_plants_op_ntilde_poiss.Rda")
# Negative Binomial
save(gg_ntilde_negbin, file = "mazziotta2016_results/mazz_plants_op_ntilde_negbin.Rda")

######### 10.b) Save results: CI for rarefaction (Poiss/NB/Gamma/SP) ################
# Poisson
saveRDS(kn_rarefaction_poiss, "mazziotta2016_results/mazz_plants_op_ci_insample_poiss.rds")
# Negative Binomial
saveRDS(kn_rarefaction_negbin, "mazziotta2016_results/mazz_plants_op_ci_insample_negbin.rds")
# Gamma IBP
saveRDS(kn_rarefaction_ibp, "mazziotta2016_results/mazz_plants_op_ci_insample_ibp.rds")
# SB-SP
saveRDS(kn_rarefaction_sp, "mazziotta2016_results/mazz_plants_op_ci_insample_sp.rds")
