...
# load(file = "mazziotta2016_results/mazz_lichens_params_poiss.Rda")
# load(file =  "mazziotta2016_results/mazz_lichens_params_negbin.Rda")
# load(file =  "mazziotta2016_results/mazz_lichens_params_ibp.Rda" )
# load(file =  "mazziotta2016_results/mazz_lichens_params_sp.Rda" )
# 
# ###### 2) Read results: samples from limiting distributions (Poiss/NB) ##############
# load(file = "mazziotta2016_results/mazz_lichens_ntilde_poiss.Rda")
# load(file = "mazziotta2016_results/mazz_lichens_ntilde_negbin.Rda")
# 
# ###### 3) Read results: CI for extrapolation (Poiss/NB/Gamma) ################
# list_kmn_pred_test_poiss <- readRDS(file = "mazziotta2016_results/mazz_lichens_ci_poiss.rds")
# list_kmn_pred_test_negbin <- readRDS(file = "mazziotta2016_results/mazz_lichens_ci_negbin.rds")
# list_kmn_pred_test_ibp <- readRDS(file = "mazziotta2016_results/mazz_lichens_ci_ibp.rds")
# list_kmn_pred_test_sp <- readRDS(file = "mazziotta2016_results/mazz_lichens_ci_sp.rds")
# 
# ###### 3.b) Read results: CI for insample (Poiss/NB/Gamma) ################
# list_kn_rarefaction_poiss <- readRDS(file = "mazziotta2016_results/mazz_lichens_ci_insample_poiss.rds")
# list_kn_rarefaction_negbin <- readRDS(file = "mazziotta2016_results/mazz_lichens_ci_insample_negbin.rds")
# list_kn_rarefaction_ibp <- readRDS(file = "mazziotta2016_results/mazz_lichens_ci_insample_ibp.rds")
# list_kn_rarefaction_sp <- readRDS(file = "mazziotta2016_results/mazz_lichens_ci_insample_sp.rds")
# 
# 
# ###### 4) Read the data ###############################
...
# 
# # Print plots
# fig_lichens2016_rare_ <- wrap_plots(gg_kn_rarefaction_all, nrow = 1, ncol = 3) +   plot_layout(guides = "collect") & theme(legend.position = 'right') & xlab(NULL) & theme(plot.margin = margin(5.5, 5.5, 0, 5.5))
# 
# fig_lichens2016_rare <- wrap_elements(panel = fig_lichens2016_rare_) +
#   labs(tag = "# observations") +
#   theme(
#     plot.tag = element_text(size = rel(1)),
#     plot.tag.position = "bottom") 
# 
# ggsave(filename = "Plots_paper/plot_lichens2016_rare.png", width = 10, height = 4, dpi = 300, units = "in", device='png')
# 
# 
# ###### 7) Prediction
...
# 
# # Print plots
# fig_lichens2016_pred_ <- wrap_plots(gg_kmn_pred_test_all, nrow = 1, ncol = 3) +   plot_layout(guides = "collect") & theme(legend.position = 'right') & xlab(NULL) & theme(plot.margin = margin(5.5, 5.5, 0, 5.5))
# 
# fig_lichens2016_pred <- wrap_elements(panel = fig_lichens2016_pred_) +
#   labs(tag = "# observations") +
#   theme(
#     plot.tag = element_text(size = rel(1)),
#     plot.tag.position = "bottom") 
# 
# ggsave(filename = "Plots_paper/plot_lichens2016_pred.png", width = 10, height = 4, dpi = 300, units = "in", device='png')
# 
# 
# ###### 8) Richness
...
#                                 "BBmixNB" = "royalblue1")) 
# 
# ggsave(filename = "Plots_paper/plot_lichens2016_richness.png", width = 10, height = 4, dpi = 300, units = "in", device='png')
...
###### 1) Read results:  MCMC convergence ####################
load(file = "mazziotta2016_application/mazz_lichens_op_params_poiss.Rda")
load(file =  "mazziotta2016_application/mazz_lichens_op_params_negbin.Rda")
#load(file =  "mazziotta2016_application/mazz_lichens_op_params_negbin_prior.Rda")
load(file =  "mazziotta2016_application/mazz_lichens_op_params_ibp.Rda" )
#load(file =  "mazziotta2016_application/mazz_lichens_op_params_sp.Rda" )

###### 2) Read results: samples from limiting distributions (Poiss/NB) ##############
load(file = "mazziotta2016_application/mazz_lichens_op_ntilde_poiss.Rda")
load(file = "mazziotta2016_application/mazz_lichens_op_ntilde_negbin.Rda")
#load(file = "mazziotta2016_application/mazz_lichens_op_ntilde_negbin_prior.Rda")

###### 3) Read results: CI for extrapolation (Poiss/NB/Gamma) ################
list_kmn_pred_test_poiss <- readRDS(file = "mazziotta2016_application/mazz_lichens_op_ci_pred_poiss.rds")
list_kmn_pred_test_negbin <- readRDS(file = "mazziotta2016_application/mazz_lichens_op_ci_pred_negbin.rds")
#list_kmn_pred_test_negbin_prior <- readRDS(file = "mazziotta2016_application/mazz_lichens_op_ci_pred_negbin_prior.rds")
list_kmn_pred_test_ibp <- readRDS(file = "mazziotta2016_application/mazz_lichens_op_ci_pred_ibp.rds")
#list_kmn_pred_test_sp <- readRDS(file = "mazziotta2016_application/mazz_lichens_op_ci_sp.rds")

# ###### 3.b) Read results: CI for insample (Poiss/NB/Gamma) ################
# list_kn_rarefaction_poiss <- readRDS(file = "mazziotta2016_application/mazz_lichens_op_ci_insample_poiss.rds")
# list_kn_rarefaction_negbin <- readRDS(file = "mazziotta2016_application/mazz_lichens_op_ci_insample_negbin.rds")
# #list_kn_rarefaction_negbin_prior <- readRDS(file = "mazziotta2016_application/mazz_lichens_op_ci_insample_negbin_prior.rds")
# list_kn_rarefaction_ibp <- readRDS(file = "mazziotta2016_application/mazz_lichens_op_ci_insample_ibp.rds")
# #list_kn_rarefaction_sp <- readRDS(file = "mazziotta2016_application/mazz_lichens_op_ci_insample_sp.rds")


###### 4) Read the data ###############################
data_mat <- readRDS(file = "mazziotta2016_application/mazz_lichens_data_mat.rds")
data_list <- create_features_list(data_mat)
L <- nrow(data_mat)
...
ggsave(filename = "Plots_paper/plot_lichens2016_op_richness.png", width = 10, height = 4, dpi = 300, units = "in", device='png')
...
# Print plots
fig_lichens2016_op_pred_ <- wrap_plots(gg_kmn_pred_test_all, nrow = 1, ncol = 3) +   plot_layout(guides = "collect") & theme(legend.position = 'right') & xlab(NULL) & theme(plot.margin = margin(5.5, 5.5, 0, 5.5))

fig_lichens2016_op_pred <- wrap_elements(panel = fig_lichens2016_op_pred_) +
  labs(tag = "# observations") +
  theme(
    plot.tag = element_text(size = rel(1)),
    plot.tag.position = "bottom") 

ggsave(filename = "Plots_paper/plot_lichens2016_op_pred.png", width = 10, height = 4, dpi = 300, units = "in", device='png')
