...
save(params_poiss, file = "chao_model_simulation/m2/m2_params_poiss.Rda")
save(params_negbin, file = "chao_model_simulation/m2/m2_params_negbin.Rda")
save(params_ibp, file = "chao_model_simulation/m2/m2_params_ibp.Rda")

############ 9) Save results: samples from limiting distributions (Poiss/NB) ##############
# Poisson
save(gg_ntilde_poiss, file = "chao_model_simulation/m2/m2_ntilde_poiss.Rda")
# Negative Binomial
save(gg_ntilde_negbin, file = "chao_model_simulation/m2/m2_ntilde_negbin.Rda")

######### 10) Save results: CI for extrapolation (Poiss/NB/Gamma) ################
# Poisson
saveRDS(list_kmn_pred_test_poiss, "chao_model_simulation/m2/m2_ci_poiss.rds")
# Negative Binomial
saveRDS(list_kmn_pred_test_negbin, "chao_model_simulation/m2/m2_ci_negbin.rds")
# Gamma IBP
saveRDS(list_kmn_pred_test_ibp, "chao_model_simulation/m2/m2_ci_ibp.rds")


######## 11) Save the data ##############################
saveRDS(data_mat, "chao_model_simulation/m2/m2_data_mat.rds")
...
save(avg_ntilde_poiss, file = "chao_model_simulation/m2/m2_avg_ntilde_poiss.Rda")
save(avg_ntilde_negbin, file = "chao_model_simulation/m2/m2_avg_ntilde_negbin.Rda")


###### 9) Save results: quantities for accuracy #####
save(obs_train, file = "chao_model_simulation/m2/m2_obs_train.Rda")
save(obs_new, file = "chao_model_simulation/m2/m2_obs_new.Rda")
save(est_new_poiss, file = "chao_model_simulation/m2/m2_est_new_poiss.Rda")
save(est_new_negbin, file = "chao_model_simulation/m2/m2_est_new_negbin.Rda")
save(est_new_ibp, file = "chao_model_simulation/m2/m2_est_new_ibp.Rda")
