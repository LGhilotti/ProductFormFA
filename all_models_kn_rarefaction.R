...
# Poisson
saveRDS(list_kn_rarefaction_poiss, "unbounded_features_scenario/unb_ci_insample_poiss.rds")
# Negative Binomial
saveRDS(list_kn_rarefaction_negbin, "unbounded_features_scenario/unb_ci_insample_negbin.rds")
# Gamma IBP
saveRDS(list_kn_rarefaction_ibp, "unbounded_features_scenario/unb_ci_insample_ibp.rds")
