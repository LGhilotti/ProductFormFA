...
load(file = "unbounded_features_scenario/unb_poly_1_ntilde_poiss.Rda")
load(file = "unbounded_features_scenario/unb_poly_1_ntilde_negbin.Rda")
...
list_kmn_pred_test_negbin <- readRDS(file = "unbounded_features_scenario/unb_poly_1_ci_negbin.rds")
list_kmn_pred_test_ibp <- readRDS(file = "unbounded_features_scenario/unb_poly_1_ci_ibp.rds")
...
ggsave("unbounded_features_scenario/unb_poly_1_poiss_extr.pdf", width = 16, height = 8, units = "in")

# Negative Binomial
ggarrange(plotlist = gg_kmn_pred_test_negbin)
ggsave("unbounded_features_scenario/unb_poly_1_negbin_extr.pdf", width = 16, height = 8, units = "in")

# Gamma IBP
ggarrange(plotlist = gg_kmn_pred_test_ibp)
ggsave("unbounded_features_scenario/unb_poly_1_ibp_extr.pdf", width = 16, height = 8, units = "in")
...
load(file = "unbounded_features_scenario/unb_poly_1_avg_ntilde_poiss.Rda")
load(file = "unbounded_features_scenario/unb_poly_1_avg_ntilde_negbin.Rda")

###### 2) Read results: quantities on accuracy #####
load(file = "unbounded_features_scenario/unb_poly_1_obs_train.Rda")
load(file = "unbounded_features_scenario/unb_poly_1_obs_new.Rda")

load(file = "unbounded_features_scenario/unb_poly_1_est_new_poiss.Rda")
load(file = "unbounded_features_scenario/unb_poly_1_est_new_negbin.Rda")
load(file = "unbounded_features_scenario/unb_poly_1_est_new_ibp.Rda")
