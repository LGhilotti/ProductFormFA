...
ggsave("unbounded_features_simulation/unb_poly_1/unb_poly_1_poiss_extr.pdf", width = 16, height = 8, units = "in")

# Negative Binomial
ggarrange(plotlist = gg_kmn_pred_test_negbin)
ggsave("unbounded_features_simulation/unb_poly_1/unb_poly_1_negbin_extr.pdf", width = 16, height = 8, units = "in")
