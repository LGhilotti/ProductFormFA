...
ggsave("unbounded_features_scenario/unb_poiss_extr.pdf", width = 16, height = 8, units = "in")

# Negative Binomial
ggarrange(plotlist = gg_kmn_pred_test_negbin)
ggsave("unbounded_features_scenario/unb_negbin_extr.pdf", width = 16, height = 8, units = "in")

# Gamma IBP
ggarrange(plotlist = gg_kmn_pred_test_ibp)
ggsave("unbounded_features_scenario/unb_ibp_extr.pdf", width = 16, height = 8, units = "in")
