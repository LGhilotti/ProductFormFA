####
##### Unbounded-features scenario_ Polynomial (exponent: 1.2) ############################
####
...
#load(file =  "unbounded_features_simulation/unb_poly_1_2/unb_poly_1_2_params_negbin_prior.Rda")
...
#load(file = "unbounded_features_simulation/unb_poly_1_2/unb_poly_1_2_ntilde_negbin_prior.Rda")
...
#list_kmn_pred_test_negbin_prior <- readRDS(file = "unbounded_features_simulation/unb_poly_1_2/unb_poly_1_2_ci_negbin_prior.rds")
...
# #list_kn_rarefaction_negbin_prior <- readRDS(file = "unbounded_features_simulation/unb_poly_1_2/unb_poly_1_2_ci_insample_negbin_prior.rds")
...
ggsave(filename = "Plots_paper/plot_unb_poly_1_2_richness.png", width = 10, height = 4, dpi = 300, units = "in", device='png')
...
# Print plots
fig_unb_poly_1_2_pred_ <- wrap_plots(gg_kmn_pred_test_all, nrow = 3, ncol = 3) +   plot_layout(guides = "collect") & theme(legend.position = 'right') & xlab(NULL) & theme(plot.margin = margin(5.5, 5.5, 0, 5.5))

fig_unb_poly_1_2_pred <- wrap_elements(panel = fig_unb_poly_1_2_pred_) +
