...
# saveRDS(list_kmn_pred_test_gt, "unbounded_features_simulation/unb_poly_0_8/unb_poly_0_8_gt_prediction.rds")

# read
list_kmn_pred_test_gt <- readRDS(file = "unbounded_features_simulation/unb_poly_0_8/unb_poly_0_8_gt_prediction.rds")
...
load(file = "unbounded_features_simulation/unb_poly_0_8/unb_poly_0_8_est_last_gt.Rda")
