...
# saveRDS(list_kmn_pred_test_gt, "unbounded_features_simulation/unb_poly_1_2/unb_poly_1_2_gt_prediction.rds")

# read
list_kmn_pred_test_gt <- readRDS(file = "unbounded_features_simulation/unb_poly_1_2/unb_poly_1_2_gt_prediction.rds")
...
ggsave(filename = "Plots_paper/plot_unb_poly_1_2_prediction.pdf", width = 10, height = 4, dpi = 300, units = "in", device='pdf')
...
load(file = "unbounded_features_simulation/unb_poly_1_2/unb_poly_1_2_est_last_gt.Rda")
...
ggsave(filename = "Plots_paper/plot_unb_poly_1_2_accuracy_rep.pdf", width = 10, height = 4, dpi = 300, units = "in", device='pdf')
