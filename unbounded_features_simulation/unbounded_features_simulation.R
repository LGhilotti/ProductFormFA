...
save(params_poiss, file = "unbounded_features_scenario/unb_params_poiss.Rda")
save(params_negbin, file = "unbounded_features_scenario/unb_params_negbin.Rda")
save(params_ibp, file = "unbounded_features_scenario/unb_params_ibp.Rda")

############ 9) Save results: samples from limiting distributions (Poiss/NB) ##############
# Poisson
save(gg_ntilde_poiss, file = "unbounded_features_scenario/unb_ntilde_poiss.Rda")
# Negative Binomial
save(gg_ntilde_negbin, file = "unbounded_features_scenario/unb_ntilde_negbin.Rda")

######### 10) Save results: CI for extrapolation (Poiss/NB/Gamma) ################
# Poisson
saveRDS(list_kmn_pred_test_poiss, "unbounded_features_scenario/unb_ci_poiss.rds")
# Negative Binomial
saveRDS(list_kmn_pred_test_negbin, "unbounded_features_scenario/unb_ci_negbin.rds")
# Gamma IBP
saveRDS(list_kmn_pred_test_ibp, "unbounded_features_scenario/unb_ci_ibp.rds")


######### 11) Save the data ##############################
saveRDS(data_mat, "unbounded_features_scenario/unb_data_mat.rds")
...
save(avg_ntilde_poiss, file = "unbounded_features_scenario/unb_avg_ntilde_poiss.Rda")
save(avg_ntilde_negbin, file = "unbounded_features_scenario/unb_avg_ntilde_negbin.Rda")


###### 9) Save results: quantities for accuracy #####
save(obs_train, file = "unbounded_features_scenario/unb_obs_train.Rda")
save(obs_new, file = "unbounded_features_scenario/unb_obs_new.Rda")
save(est_new_poiss, file = "unbounded_features_scenario/unb_est_new_poiss.Rda")
save(est_new_negbin, file = "unbounded_features_scenario/unb_est_new_negbin.Rda")
save(est_new_ibp, file = "unbounded_features_scenario/unb_est_new_ibp.Rda")
