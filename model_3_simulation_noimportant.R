...
ggsave("chao_model_simulation/m3_poiss_mix.pdf", width = 16, height = 12, units = "in")
...
ggs_traceplot(samples_ggs_negbin) + 
  facet_wrap(~Parameter, nrow = length(Ns), scales = "free")
ggsave("chao_model_simulation/m3_negbin_mix.pdf", width = 16, height = 12, units = "in")
...
ggs_traceplot(samples_ggs_ibp) + 
  facet_wrap(~Parameter, nrow = length(Ns), scales = "free")
ggsave("chao_model_simulation/m3_gamma_mix.pdf", width = 16, height = 12, units = "in")
...
ggs_density(samples_ntilde_ggs_poiss) + 
  facet_wrap(~Parameter, nrow = length(Ns), scales = "free")
ggsave("chao_model_simulation/m3_poiss_limit.pdf", width = 12, height = 12, units = "in")
...
ggs_density(samples_ntilde_ggs_negbin) + 
  facet_wrap(~Parameter, nrow = length(Ns), scales = "free")
ggsave("chao_model_simulation/m3_negbin_limit.pdf", width = 12, height = 12, units = "in")

######### 10) Plot Extrapolation curve (Poiss/NB/Gamma) ################
# Poisson
ggarrange(plotlist = gg_kmn_pred_test_poiss)
ggsave("chao_model_simulation/m3_poiss_extr.pdf", width = 16, height = 8, units = "in")

# Negative Binomial
ggarrange(plotlist = gg_kmn_pred_test_negbin)
ggsave("chao_model_simulation/m3_negbin_extr.pdf", width = 16, height = 8, units = "in")

# Gamma IBP
ggarrange(plotlist = gg_kmn_pred_test_ibp)
ggsave("chao_model_simulation/m3_gamma_extr.pdf", width = 16, height = 8, units = "in")
