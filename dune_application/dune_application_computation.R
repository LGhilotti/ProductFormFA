##############################################################
############ REAL DATA APPLICATION: DUNE (vegan) ###################
#############################################################
rm(list=ls())
...
data(dune)
dune_mat <- as.matrix((dune > 0) +0)
freq <- colSums(dune_mat)
...
dune_list <- create_features_list(dune_mat)
plot_trajectory(dune_list)
...
save(params_poiss, file = "dune_results/dune_params_poiss.Rda")
save(params_negbin, file = "dune_results/dune_params_negbin.Rda")
save(params_ibp, file = "dune_results/dune_params_ibp.Rda")
save(params_sp, file = "dune_results/dune_params_sp.Rda")

############ 9) Save results: samples from limiting distributions (Poiss/NB) ##############
# Poisson
save(gg_ntilde_poiss, file = "dune_results/dune_ntilde_poiss.Rda")
# Negative Binomial
save(gg_ntilde_negbin, file = "dune_results/dune_ntilde_negbin.Rda")

######### 10) Save results: CI for extrapolation (Poiss/NB/Gamma/SP) ################
# Poisson
saveRDS(list_kmn_pred_test_poiss, "dune_results/dune_ci_poiss.rds")
# Negative Binomial
saveRDS(list_kmn_pred_test_negbin, "dune_results/dune_ci_negbin.rds")
# Gamma IBP
saveRDS(list_kmn_pred_test_ibp, "dune_results/dune_ci_ibp.rds")
# SB-SP
saveRDS(list_kmn_pred_test_sp, "dune_results/dune_ci_sp.rds")

######### 10.b) Save results: CI for rarefaction (Poiss/NB/Gamma/SP) ################
# Poisson
saveRDS(list_kn_rarefaction_poiss, "dune_results/dune_ci_insample_poiss.rds")
# Negative Binomial
saveRDS(list_kn_rarefaction_negbin, "dune_results/dune_ci_insample_negbin.rds")
# Gamma IBP
saveRDS(list_kn_rarefaction_ibp, "dune_results/dune_ci_insample_ibp.rds")
# SB-SP
saveRDS(list_kn_rarefaction_sp, "dune_results/dune_ci_insample_sp.rds")

######## 11) Save the data ##############################
saveRDS(data_mat, "dune_results/dune_data_mat.rds")
...
save(params_poiss, file = "dune_results/dune_op_params_poiss.Rda")
save(params_negbin, file = "dune_results/dune_op_params_negbin.Rda")
save(params_ibp, file = "dune_results/dune_op_params_ibp.Rda")
save(params_sp, file = "dune_results/dune_op_params_sp.Rda")

############ 9) Save results: samples from limiting distributions (Poiss/NB) ##############
# Poisson
save(gg_ntilde_poiss, file = "dune_results/dune_op_ntilde_poiss.Rda")
# Negative Binomial
save(gg_ntilde_negbin, file = "dune_results/dune_op_ntilde_negbin.Rda")

######### 10.b) Save results: CI for rarefaction (Poiss/NB/Gamma/SP) ################
# Poisson
saveRDS(kn_rarefaction_poiss, "dune_results/dune_op_ci_insample_poiss.rds")
# Negative Binomial
saveRDS(kn_rarefaction_negbin, "dune_results/dune_op_ci_insample_negbin.rds")
# Gamma IBP
saveRDS(kn_rarefaction_ibp, "dune_results/dune_op_ci_insample_ibp.rds")
# SB-SP
saveRDS(kn_rarefaction_sp, "dune_results/dune_op_ci_insample_sp.rds")
