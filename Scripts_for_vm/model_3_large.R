...
gibbs_sampler_poiss_fixed_lambda <- function(Z, 
  ...
  mode_post <- optim(par = c(0,0), fn = neg_log_posterior_poiss, n = n, K = K, counts = counts,
                     ...
                     lower = c(-10000,-10000), upper = c(10000,10000),
                     method = "L-BFGS-B")$par
...
# #save(params_negbin_prior, file = "m3_params_negbin_prior.Rda")
# save(params_ibp, file = "m3_params_ibp.Rda")
# #save(params_sp, file = "m3_params_sp.Rda")

############ 9) Save results: samples from limiting distributions (Poiss/NB) ##############
# Poisson
save(gg_ntilde_poiss, file = "m3_ntilde_poiss_large.Rda")
# Negative Binomial (fixed)
save(gg_ntilde_negbin, file = "m3_ntilde_negbin_large.Rda")
...
######## 11) Save the data ##############################
saveRDS(data_mat, "m3_data_mat_large.rds")
