...
gg_ntilde_poiss[[paste("N.",L)]] <- ntilde_chain_poiss
...
######### 10.b) Save results: CI for rarefaction (Poiss/NB/Gamma/SP) ################
# Poisson
saveRDS(kn_rarefaction_poiss, "mazz_plants_op_ci_insample_poiss.rds")
# Negative Binomial
saveRDS(kn_rarefaction_negbin, "mazz_plants_op_ci_insample_negbin.rds")
# Gamma IBP
saveRDS(kn_rarefaction_ibp, "mazz_plants_op_ci_insample_ibp.rds")
# SB-SP
