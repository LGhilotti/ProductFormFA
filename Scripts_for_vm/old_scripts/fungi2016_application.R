...
######### 10.b) Save results: CI for rarefaction (Poiss/NB/Gamma/SP) ################
# Poisson
#saveRDS(kn_rarefaction_poiss, "mazz_fungi_op_ci_insample_poiss.rds")
# Negative Binomial
saveRDS(kn_rarefaction_negbin, "mazz_fungi_op_ci_insample_negbin.rds")
# # Gamma IBP
# saveRDS(kn_rarefaction_ibp, "mazz_fungi_op_ci_insample_ibp.rds")
# # SB-SP
