...
# save(params_poiss, file = "m5_params_poiss.Rda")
# save(params_negbin, file = "m5_params_negbin.Rda")
# save(params_ibp, file = "m5_params_ibp.Rda")
save(params_sp, file = "m5_params_sp.Rda")

############ 9) Save results: samples from limiting distributions (Poiss/NB) ##############
# # Poisson
# save(gg_ntilde_poiss, file = "m5_ntilde_poiss.Rda")
# # Negative Binomial
# save(gg_ntilde_negbin, file = "m5_ntilde_negbin.Rda")

######### 10) Save results: CI for extrapolation (Poiss/NB/Gamma) ################
# # Poisson
# saveRDS(list_kmn_pred_test_poiss, "m5_ci_poiss.rds")
# # Negative Binomial
# saveRDS(list_kmn_pred_test_negbin, "m5_ci_negbin.rds")
# # Gamma IBP
# saveRDS(list_kmn_pred_test_ibp, "m5_ci_ibp.rds")
# SB-SP
saveRDS(list_kmn_pred_test_sp, "m5_ci_sp.rds")


######## 11) Save the data ##############################
# saveRDS(data_mat, "m5_data_mat.rds")
...
# save(avg_ntilde_poiss, file = "m5_avg_ntilde_poiss.Rda")
# save(avg_ntilde_negbin, file = "m5_avg_ntilde_negbin.Rda")


###### 9) Save results: quantities for accuracy #####
# save(obs_train, file = "m5_obs_train.Rda")
# save(obs_new, file = "m5_obs_new.Rda")
# save(est_new_poiss, file = "m5_est_new_poiss.Rda")
# save(est_new_negbin, file = "m5_est_new_negbin.Rda")
# save(est_new_ibp, file = "m5_est_new_ibp.Rda")
save(est_new_sp, file = "m5_est_new_sp.Rda")
