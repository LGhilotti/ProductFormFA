...
save(params_poiss, file = "bauges_params_poiss.Rda")
save(params_negbin, file = "bauges_params_negbin.Rda")
save(params_ibp, file = "bauges_params_ibp.Rda")
save(params_sp, file = "bauges_params_sp.Rda")

############ 9) Save results: samples from limiting distributions (Poiss/NB) ##############
# Poisson
save(gg_ntilde_poiss, file = "bauges_ntilde_poiss.Rda")
# Negative Binomial
save(gg_ntilde_negbin, file = "bauges_ntilde_negbin.Rda")

######### 10) Save results: CI for extrapolation (Poiss/NB/Gamma/SP) ################
# Poisson
saveRDS(list_kmn_pred_test_poiss, "bauges_ci_poiss.rds")
# Negative Binomial
saveRDS(list_kmn_pred_test_negbin, "bauges_ci_negbin.rds")
# Gamma IBP
saveRDS(list_kmn_pred_test_ibp, "bauges_ci_ibp.rds")
# SB-SP
saveRDS(list_kmn_pred_test_sp, "bauges_ci_sp.rds")

######### 10.b) Save results: CI for rarefaction (Poiss/NB/Gamma/SP) ################
# Poisson
saveRDS(list_kn_rarefaction_poiss, "bauges_ci_insample_poiss.rds")
# Negative Binomial
saveRDS(list_kn_rarefaction_negbin, "bauges_ci_insample_negbin.rds")
# Gamma IBP
saveRDS(list_kn_rarefaction_ibp, "bauges_ci_insample_ibp.rds")
# SB-SP
saveRDS(list_kn_rarefaction_sp, "bauges_ci_insample_sp.rds")

######## 11) Save the data ##############################
saveRDS(data_mat, "bauges_data_mat.rds")
