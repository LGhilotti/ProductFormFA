...
save(params_poiss, file = "unb_exp_params_poiss.Rda")
save(params_negbin, file = "unb_exp_params_negbin.Rda")
save(params_ibp, file = "unb_exp_params_ibp.Rda")

############ 9) Save results: samples from limiting distributions (Poiss/NB) ##############
# Poisson
save(gg_ntilde_poiss, file = "unb_exp_ntilde_poiss.Rda")
# Negative Binomial
save(gg_ntilde_negbin, file = "unb_exp_ntilde_negbin.Rda")

######### 10) Save results: CI for extrapolation (Poiss/NB/Gamma) ################
# Poisson
saveRDS(list_kmn_pred_test_poiss, "unb_exp_ci_poiss.rds")
# Negative Binomial
saveRDS(list_kmn_pred_test_negbin, "unb_exp_ci_negbin.rds")
# Gamma IBP
saveRDS(list_kmn_pred_test_ibp, "unb_exp_ci_ibp.rds")


######### 11) Save the data ##############################
saveRDS(data_mat, "unb_exp_data_mat.rds")
...
save(avg_ntilde_poiss, file = "unb_exp_avg_ntilde_poiss.Rda")
save(avg_ntilde_negbin, file = "unb_exp_avg_ntilde_negbin.Rda")


###### 9) Save results: quantities for accuracy #####
save(obs_train, file = "unb_exp_obs_train.Rda")
save(obs_new, file = "unb_exp_obs_new.Rda")
save(est_new_poiss, file = "unb_exp_est_new_poiss.Rda")
save(est_new_negbin, file = "unb_exp_est_new_negbin.Rda")
save(est_new_ibp, file = "unb_exp_est_new_ibp.Rda")