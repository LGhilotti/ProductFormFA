...
# save(avg_ntilde_negbin_prior, file = "m2_avg_ntilde_negbin_prior.Rda")
# 
# 
...
# save(est_new_negbin_prior, file = "m2_est_new_negbin_prior.Rda")
# save(est_new_ibp, file = "m2_est_new_ibp.Rda")
# save(est_new_sp, file = "m2_est_new_sp.Rda")
