...
#save(params_negbin_prior, file = "unb_poly_1_2_params_negbin_prior.Rda")
...
#save(gg_ntilde_negbin_prior, file = "unb_poly_1_2_ntilde_negbin_prior.Rda")
...
# Negative Binomial (prior)
#saveRDS(list_kmn_pred_test_negbin_prior, "unb_poly_1_2_ci_negbin_prior.rds")
# Gamma IBP
...
# save(avg_ntilde_negbin_prior, file = "unb_poly_1_2_avg_ntilde_negbin_prior.Rda")
# 
# 
...
# save(est_new_negbin_prior, file = "unb_poly_1_2_est_new_negbin_prior.Rda")
