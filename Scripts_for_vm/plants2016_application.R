...
plants2016_mat <- read_excel('mazz2016_data.xls',
                            sheet = "Plants") %>%
...
# 
# save(params_poiss, file = "mazz_plants_params_poiss.Rda")
# save(params_negbin, file = "mazz_plants_params_negbin.Rda")
# save(params_ibp, file = "mazz_plants_params_ibp.Rda")
# save(params_sp, file = "mazz_plants_params_sp.Rda")
# 
# ############ 9) Save results: samples from limiting distributions (Poiss/NB) ##############
# # Poisson
# save(gg_ntilde_poiss, file = "mazz_plants_ntilde_poiss.Rda")
# # Negative Binomial
# save(gg_ntilde_negbin, file = "mazz_plants_ntilde_negbin.Rda")
# 
# ######### 10) Save results: CI for extrapolation (Poiss/NB/Gamma/SP) ################
# # Poisson
# saveRDS(list_kmn_pred_test_poiss, "mazz_plants_ci_poiss.rds")
# # Negative Binomial
# saveRDS(list_kmn_pred_test_negbin, "mazz_plants_ci_negbin.rds")
# # Gamma IBP
# saveRDS(list_kmn_pred_test_ibp, "mazz_plants_ci_ibp.rds")
# # SB-SP
# saveRDS(list_kmn_pred_test_sp, "mazz_plants_ci_sp.rds")
# 
# ######### 10.b) Save results: CI for rarefaction (Poiss/NB/Gamma/SP) ################
# # Poisson
# saveRDS(list_kn_rarefaction_poiss, "mazz_plants_ci_insample_poiss.rds")
# # Negative Binomial
# saveRDS(list_kn_rarefaction_negbin, "mazz_plants_ci_insample_negbin.rds")
# # Gamma IBP
# saveRDS(list_kn_rarefaction_ibp, "mazz_plants_ci_insample_ibp.rds")
# # SB-SP
# saveRDS(list_kn_rarefaction_sp, "mazz_plants_ci_insample_sp.rds")
# 
# ######## 11) Save the data ##############################
# saveRDS(data_mat, "mazz_plants_data_mat.rds")
...
save(params_poiss, file = "mazz_plants_op_params_poiss.Rda")
save(params_negbin, file = "mazz_plants_op_params_negbin.Rda")
save(params_ibp, file = "mazz_plants_op_params_ibp.Rda")

############ 9) Save results: samples from limiting distributions (Poiss/NB) ##############
# Poisson
save(gg_ntilde_poiss, file = "mazz_plants_op_ntilde_poiss.Rda")
# Negative Binomial
save(gg_ntilde_negbin, file = "mazz_plants_op_ntilde_negbin.Rda")

######### 10.a) Save results: CI for prediction (Poiss/NB/Gamma/SP) ################
# Poisson
saveRDS(list_kmn_pred_poiss , "mazz_plants_op_ci_pred_poiss.rds")
# Negative Binomial
saveRDS(list_kmn_pred_negbin, "mazz_plants_op_ci_pred_negbin.rds")
# # Gamma IBP
saveRDS(list_kmn_pred_ibp, "mazz_plants_op_ci_pred_ibp.rds")

# ######### 10.b) Save results: CI for rarefaction (Poiss/NB/Gamma/SP) ################
# # Poisson
# saveRDS(list_kn_rare_poiss, "mazz_plants_op_ci_insample_poiss.rds")
# # Negative Binomial
# saveRDS(list_kn_rare_negbin, "mazz_plants_op_ci_insample_negbin.rds")
# # # Gamma IBP
# saveRDS(list_kn_rare_ibp, "mazz_plants_op_ci_insample_ibp.rds")
# # # SB-SP
# # saveRDS(kn_rarefaction_sp, "mazz_plants_op_ci_insample_sp.rds")
...
# Chao rarefaction
saveRDS(list_chao_rare, "mazz_plants_chao_rare.rds")
...
saveRDS(list_kmn_pred_gt, "mazz_plants_gt_prediction.rds")
