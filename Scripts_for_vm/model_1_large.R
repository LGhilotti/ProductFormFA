...
Ns <- c(800, 2000, 10000) # c(20, 40 , 80) 
L <- 10001 # 150
...
# #save(params_negbin_prior, file = "m1_params_negbin_prior.Rda")
# save(params_ibp, file = "m1_params_ibp.Rda")
# #save(params_sp, file = "m1_params_sp.Rda")

############ 9) Save results: samples from limiting distributions (Poiss/NB) ##############
# Poisson
save(gg_ntilde_poiss, file = "m1_ntilde_poiss_large.Rda")
# Negative Binomial (fixed)
save(gg_ntilde_negbin, file = "m1_ntilde_negbin_large.Rda")
...
######## 11) Save the data ##############################
saveRDS(data_mat, "m1_data_mat_large.rds")
