...
fungi2016_mat <- read_excel('mazz2016_data.xls',
                            sheet = "Fungi") %>%
...
# number of sites
L = nrow(fungi2016_mat)

set.seed(012345)
fungi2016_mat <- fungi2016_mat[sample.int(L, size = L, replace = F),]

fungi2016_list <- create_features_list(fungi2016_mat)
#plot_trajectory(fungi2016_list)

data_mat <- fungi2016_mat
data_list <- fungi2016_list
...
# 
# save(params_poiss, file = "mazz_fungi_params_poiss.Rda")
# save(params_negbin, file = "mazz_fungi_params_negbin.Rda")
# save(params_ibp, file = "mazz_fungi_params_ibp.Rda")
# save(params_sp, file = "mazz_fungi_params_sp.Rda")
# 
# ############ 9) Save results: samples from limiting distributions (Poiss/NB) ##############
# # Poisson
# save(gg_ntilde_poiss, file = "mazz_fungi_ntilde_poiss.Rda")
# # Negative Binomial
# save(gg_ntilde_negbin, file = "mazz_fungi_ntilde_negbin.Rda")
# 
# ######### 10) Save results: CI for extrapolation (Poiss/NB/Gamma/SP) ################
# # Poisson
# saveRDS(list_kmn_pred_test_poiss, "mazz_fungi_ci_poiss.rds")
# # Negative Binomial
# saveRDS(list_kmn_pred_test_negbin, "mazz_fungi_ci_negbin.rds")
# # Gamma IBP
# saveRDS(list_kmn_pred_test_ibp, "mazz_fungi_ci_ibp.rds")
# # SB-SP
# saveRDS(list_kmn_pred_test_sp, "mazz_fungi_ci_sp.rds")
# 
# ######### 10.b) Save results: CI for rarefaction (Poiss/NB/Gamma/SP) ################
# # Poisson
# saveRDS(list_kn_rarefaction_poiss, "mazz_fungi_ci_insample_poiss.rds")
# # Negative Binomial
# saveRDS(list_kn_rarefaction_negbin, "mazz_fungi_ci_insample_negbin.rds")
# # Gamma IBP
# saveRDS(list_kn_rarefaction_ibp, "mazz_fungi_ci_insample_ibp.rds")
# # SB-SP
# saveRDS(list_kn_rarefaction_sp, "mazz_fungi_ci_insample_sp.rds")
# 
# ######## 11) Save the data ##############################
# saveRDS(data_mat, "mazz_fungi_data_mat.rds")
...
list_kmn_pred_sp <- vector(mode="list", length = 1)
names(list_kmn_pred_sp) <- labels_comb
...
colnames(params_sp) <- paste(c("c", "beta", "alpha"), rep(labels_comb, each = 3), sep = ":")
...
params_sp[[lab_alpha]] <- alpha_chain_sp
...
list_kmn_pred_sp[[labels_comb]] <- est_ci_pred_sp



############# 8) Save results:  MCMC convergence ####################

# save(params_poiss, file = "mazz_fungi_op_params_poiss.Rda")
# save(params_negbin, file = "mazz_fungi_op_params_negbin.Rda")
# save(params_ibp, file = "mazz_fungi_op_params_ibp.Rda")
save(params_sp, file = "mazz_fungi_op_params_sp.Rda")

# ############ 9) Save results: samples from limiting distributions (Poiss/NB) ##############
# # Poisson
# save(gg_ntilde_poiss, file = "mazz_fungi_op_ntilde_poiss.Rda")
# # Negative Binomial
# save(gg_ntilde_negbin, file = "mazz_fungi_op_ntilde_negbin.Rda")

######### 10.a) Save results: CI for prediction (Poiss/NB/Gamma/SP) ################
# # Poisson
# saveRDS(list_kmn_pred_poiss , "mazz_fungi_op_ci_pred_poiss.rds")
# # Negative Binomial
# saveRDS(list_kmn_pred_negbin, "mazz_fungi_op_ci_pred_negbin.rds")
# # Gamma IBP
# saveRDS(list_kmn_pred_ibp, "mazz_fungi_op_ci_pred_ibp.rds")
# SB-SP
saveRDS(list_kmn_pred_sp, "mazz_fungi_op_ci_pred_sp.rds")

# ######### 10.b) Save results: CI for rarefaction (Poiss/NB/Gamma/SP) ################
# # Poisson
# saveRDS(list_kn_rare_poiss, "mazz_fungi_op_ci_insample_poiss.rds")
# # Negative Binomial
# saveRDS(list_kn_rare_negbin, "mazz_fungi_op_ci_insample_negbin.rds")
# # # Gamma IBP
# saveRDS(list_kn_rare_ibp, "mazz_fungi_op_ci_insample_ibp.rds")
# # # SB-SP
# # saveRDS(kn_rarefaction_sp, "mazz_fungi_op_ci_insample_sp.rds")
...
# 
# # Chao rarefaction
# saveRDS(list_chao_rare, "mazz_fungi_chao_rare.rds")
# 
# 
# 
...
# saveRDS(list_kmn_pred_gt, "mazz_fungi_gt_prediction.rds")
# 
# 
# 
