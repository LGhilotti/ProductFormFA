...
# # Poisson
# saveRDS(list_kn_rarefaction_poiss, "m4_ci_rare_poiss.rds")
# # Negative Binomial
# saveRDS(list_kn_rarefaction_negbin, "m4_ci_rare_negbin.rds")
# # Gamma IBP
# saveRDS(list_kn_rarefaction_ibp, "m4_ci_rare_ibp.rds")
# 
# 
# ######## 11) Save the data ##############################
...
# }
# # Chao rarefaction
# saveRDS(list_chao_rare, "m4_chao_rare.rds")
# # Chao coverage
# saveRDS(list_chao_cov, "m4_chao_coverage.rds")
# 
...
save(est_last_gt, file = "m4_est_last_gt.Rda")
save(est_last_chao, file = "m4_est_last_chao.Rda")
