...
# save(avg_ntilde_negbin_prior, file = "m3_avg_ntilde_negbin_prior.Rda")
# 
# 
...
# save(est_new_negbin_prior, file = "m3_est_new_negbin_prior.Rda")
# save(est_new_ibp, file = "m3_est_new_ibp.Rda")
# save(est_new_sp, file = "m3_est_new_sp.Rda")
# 
