...
ggsave(filename = "Plots_paper/plot_m1_richness_point.pdf", width = 10, height = 4, dpi = 300, units = "in", device='pdf')
...
ggsave(filename = "Plots_paper/plot_m1_richness_distribution.pdf", width = 10, height = 4, dpi = 300, units = "in", device='pdf')
...
ggsave(filename = "Plots_paper/plot_m1_prediction.pdf", width = 10, height = 4, dpi = 300, units = "in", device='pdf')
...
ggsave(filename = "Plots_paper/plot_m1_richness_rep.pdf", width = 10, height = 4, dpi = 300, units = "in", device='pdf')
...
ggsave(filename = "Plots_paper/plot_m1_accuracy_rep.pdf", width = 10, height = 4, dpi = 300, units = "in", device='pdf')
