...
ggsave(filename = "Plots_paper/plot_m1_richness_point.png", width = 10, height = 4, dpi = 300, units = "in", device='png')
...
ggsave(filename = "Plots_paper/plot_m1_richness_distribution.png", width = 10, height = 4, dpi = 300, units = "in", device='png')
...
ggsave(filename = "Plots_paper/plot_m1_accuracy_rep.png", width = 10, height = 4, dpi = 300, units = "in", device='png')
