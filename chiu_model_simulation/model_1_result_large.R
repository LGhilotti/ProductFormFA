...
load(file = "chiu_model_simulation/m1/m1_ntilde_poiss_large.Rda")
load(file = "chiu_model_simulation/m1/m1_ntilde_negbin_large.Rda")
#load(file = "chiu_model_simulation/m1/m1_ntilde_negbin_prior.Rda")



###### 4) Read the data ###############################
data_mat <- readRDS(file = "chiu_model_simulation/m1/m1_data_mat_large.rds")
