...
S_poiss <- S_negbin <- S_ibp <- 6*10^2
n_burnin_poiss <- n_burnin_negbin <- n_burnin_ibp<- 10^2
...
for (j in 1:length(Ns)){
  ...
  output_poiss <- gibbs_sampler_poiss_fixed_lambda(Z = train_mat,
                                      ...
                                      lambda = 100, a_alpha_bb, b_alpha_bb, a_s_bb, b_s_bb,
                                      tau_poiss,
  ...
  output_ibp <- gibbs_sampler_gamma_ibp(Z = train_mat,
                                        ...
                                        sigq_s = 0.2, sigq_alpha = 0.1, fixed = c(F,F,F,F),
  ...
  ntilde_chain_poiss <- generate_Ntilde_chain_poiss(lambda = 100, alpha_chain_poiss, 
  ...
  # Poisson
  kmn_chain_poiss <- generate_Kmn_chain_poiss(lambda = 100, alpha_chain_poiss,
...
save(params_poiss, file = "chao_model_simulation/m1/m1_params_poiss.Rda")
save(params_negbin, file = "chao_model_simulation/m1/m1_params_negbin.Rda")
save(params_ibp, file = "chao_model_simulation/m1/m1_params_ibp.Rda")

############ 9) Save results: samples from limiting distributions (Poiss/NB) ##############
# Poisson
save(gg_ntilde_poiss, file = "chao_model_simulation/m1/m1_ntilde_poiss.Rda")
# Negative Binomial
save(gg_ntilde_negbin, file = "chao_model_simulation/m1/m1_ntilde_negbin.Rda")

######### 10) Save results: CI for extrapolation (Poiss/NB/Gamma) ################
# Poisson
saveRDS(list_kmn_pred_test_poiss, "chao_model_simulation/m1/m1_ci_poiss.rds")
# Negative Binomial
saveRDS(list_kmn_pred_test_negbin, "chao_model_simulation/m1/m1_ci_negbin.rds")
# Gamma IBP
saveRDS(list_kmn_pred_test_ibp, "chao_model_simulation/m1/m1_ci_ibp.rds")


######## 11) Save the data ##############################
saveRDS(data_mat, "chao_model_simulation/m1/m1_data_mat.rds")
...
save(avg_ntilde_poiss, file = "chao_model_simulation/m1/m1_avg_ntilde_poiss.Rda")
save(avg_ntilde_negbin, file = "chao_model_simulation/m1/m1_avg_ntilde_negbin.Rda")


###### 9) Save results: quantities for accuracy #####
save(obs_train, file = "chao_model_simulation/m1/m1_obs_train.Rda")
save(obs_new, file = "chao_model_simulation/m1/m1_obs_new.Rda")
save(est_new_poiss, file = "chao_model_simulation/m1/m1_est_new_poiss.Rda")
save(est_new_negbin, file = "chao_model_simulation/m1/m1_est_new_negbin.Rda")
save(est_new_ibp, file = "chao_model_simulation/m1/m1_est_new_ibp.Rda")
