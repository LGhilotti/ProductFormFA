...
load(file = "chiu_model_simulation/m2/m2_params_poiss.Rda")
load(file =  "chiu_model_simulation/m2/m2_params_negbin.Rda")
#load(file =  "chiu_model_simulation/m2/m2_params_negbin_prior.Rda")
load(file =  "chiu_model_simulation/m2/m2_params_ibp.Rda" )
#load(file =  "chiu_model_simulation/m2/m2_params_sp.Rda" )

###### 2) Read results: samples from limiting distributions (Poiss/NB) ##############
load(file = "chiu_model_simulation/m2/m2_ntilde_poiss.Rda")
load(file = "chiu_model_simulation/m2/m2_ntilde_negbin.Rda")
#load(file = "chiu_model_simulation/m2/m2_ntilde_negbin_prior.Rda")
...
#list_kmn_pred_test_negbin_prior <- readRDS(file = "chiu_model_simulation/m2/m2_ci_negbin_prior.rds")
list_kmn_pred_test_ibp <- readRDS(file = "chiu_model_simulation/m2/m2_ci_ibp.rds")
#list_kmn_pred_test_sp <- readRDS(file = "chiu_model_simulation/m2/m2_ci_sp.rds")

# ###### 3.b) Read results: CI for insample (Poiss/NB/Gamma) ################
# list_kn_rarefaction_poiss <- readRDS(file = "chiu_model_simulation/m2/m2_ci_insample_poiss.rds")
# list_kn_rarefaction_negbin <- readRDS(file = "chiu_model_simulation/m2/m2_ci_insample_negbin.rds")
# #list_kn_rarefaction_negbin_prior <- readRDS(file = "chiu_model_simulation/m2/m2_ci_insample_negbin_prior.rds")
# list_kn_rarefaction_ibp <- readRDS(file = "chiu_model_simulation/m2/m2_ci_insample_ibp.rds")
# #list_kn_rarefaction_sp <- readRDS(file = "chiu_model_simulation/m2/m2_ci_insample_sp.rds")


###### 4) Read the data ###############################
data_mat <- readRDS(file = "chiu_model_simulation/m2/m2_data_mat.rds")
...
ggplot(joint_total_long, aes(x = estimate, color = Model)) + 
  ...
  stat_density(aes(x=estimate, colour=Model),
               geom="line",position="identity", bw = 0.5) +
...
list_chao_pred <- readRDS(file = "chiu_model_simulation/m2/m2_chao_rare.rds")
...
list_kn_rarefaction_poiss <- readRDS(file = "chiu_model_simulation/m2/m2_ci_rare_poiss.rds")
list_kn_rarefaction_negbin <- readRDS(file = "chiu_model_simulation/m2/m2_ci_rare_negbin.rds")
list_kn_rarefaction_ibp <- readRDS(file = "chiu_model_simulation/m2/m2_ci_rare_ibp.rds")
...
list_chao_rare <- readRDS(file = "chiu_model_simulation/m2/m2_chao_rare.rds")
...
ggsave(filename = "Plots_paper/plot_m2_rarefaction.png", width = 10, height = 4, dpi = 300, units = "in", device='png')
...
load(file = "chiu_model_simulation/m2/m2_avg_ntilde_poiss.Rda")
load(file = "chiu_model_simulation/m2/m2_avg_ntilde_negbin.Rda")

###### 2) Read results: quantities on accuracy #####
load(file = "chiu_model_simulation/m2/m2_obs_train.Rda")
load(file = "chiu_model_simulation/m2/m2_obs_new.Rda")

load(file = "chiu_model_simulation/m2/m2_est_new_poiss.Rda")
load(file = "chiu_model_simulation/m2/m2_est_new_negbin.Rda")
load(file = "chiu_model_simulation/m2/m2_est_new_ibp.Rda")
load(file = "chiu_model_simulation/m2/m2_est_last_gt.Rda")
load(file = "chiu_model_simulation/m2/m2_est_last_chao.Rda")
...
ggsave(filename = "Plots_paper/plot_m2_accuracy_rep.png", width = 10, height = 5, dpi = 300, units = "in", device='png')
