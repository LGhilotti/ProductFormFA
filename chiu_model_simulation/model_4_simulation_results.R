...
# Print plots
fig_m4_pred_ <- wrap_plots(gg_kmn_pred_test_all, nrow = 3, ncol = 4) +   plot_layout(guides = "collect") & theme(legend.position = 'right') & xlab(NULL) & theme(plot.margin = margin(5.5, 5.5, 0, 5.5))
